...
const SHIRTS = [
  ...
  { id: 'shirt-artios', prompt: `Change this beaver's shirt to a white t-shirt with a cool abstract olive/yellow-green (#a8ad00) graphic design on the front — a stylized organic brushstroke swirl pattern, like a fluid calligraphic flourish. No text or words on the shirt. Also remove any hat from the head. ${KEEP_SAME}` },
